...
def export_surveys(conn, output_dir):
    ...
    SELECT
        ...
        pl.bfi_artistic,
        pl.bfi_outgoing,
        pl.bfi_fault_finding,
        pl.bfi_thorough,
        pl.bfi_nervous,
        pl.bfi_imagination,
        pl.aa_trust_algorithms,
        pl.aa_prefer_people,
        pl.aa_rely_algorithms,
        pl.aa_easier_algorithm,
        pl.aa_algorithms_accurate,
        pl.aa_humans_better,
        pl.nfc_complex_problems,
        pl.nfc_responsibility_thinking,
        pl.nfc_thinking_not_fun,
        pl.nfc_little_thought,
        pl.nfc_new_solutions,
        pl.nfc_intellectual_task,
        pl.pt_trust_until_reason,
        pl.pt_trust_little_knowledge,
        pl.pt_not_trust_strangers,
        pl.pt_comfortable_trusting,
        pl.gaais_p_interested,
        pl.gaais_p_perform_better,
        pl.gaais_p_welcome,
        pl.gaais_p_exciting,
        pl.gaais_p_positive,
        pl.gaais_p_trust_recommend,
        pl.gaais_p_comfort,
        pl.gaais_p_good_thing,
        pl.gaais_p_health_advisor,
        pl.gaais_p_benefit_society,
        pl.crt_car_bus,
        pl.crt_nurses,
        pl.crt_seaweed,
        pl.crt_car_bus_correct,
        pl.crt_nurses_correct,
        pl.crt_seaweed_correct,
        pl.crt_score
